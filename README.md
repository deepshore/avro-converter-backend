...
### Verification
From the workflow step `Deploy Cloud Run` copy out url `https://xsd2avro-__________run.app` of the invoke endpoint:
```
Invoke endpoint:
https://xsd2avro-__________run.app
```

Call the api endpoint:
```
curl https://xsd2avro-__________run.app/xsd2avro
```
